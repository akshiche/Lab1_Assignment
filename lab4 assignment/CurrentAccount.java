...
public class CurrentAccount extends Account{
	...
	*/
	...
	/*
	* open current account with initial balance.
	* open current account for a person.
	* overDraftLimit to withdraw till this limit even when the balance in account is zero.
	*/
